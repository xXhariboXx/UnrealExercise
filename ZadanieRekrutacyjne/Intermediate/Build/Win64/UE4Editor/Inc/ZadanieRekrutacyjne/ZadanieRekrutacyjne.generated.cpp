...
FName ZADANIEREKRUTACYJNE_ServerSetLightColor = FName(TEXT("ServerSetLightColor"));
	...
	IMPLEMENT_CLASS(ALightBulb, 1416666327);
	void ALightBulbController::StaticRegisterNativesALightBulbController()
	{
	}
	IMPLEMENT_CLASS(ALightBulbController, 3746490399);
	void AMyPawn::StaticRegisterNativesAMyPawn()
	{
	}
	IMPLEMENT_CLASS(AMyPawn, 4288345404);
...
// Cross Module References
	...
	ZADANIEREKRUTACYJNE_API class UClass* Z_Construct_UClass_ALightBulbController_NoRegister();
	ZADANIEREKRUTACYJNE_API class UClass* Z_Construct_UClass_ALightBulbController();
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	UFunction* Z_Construct_UFunction_ALightBulb_ServerSetLightColor()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("ServerSetLightColor"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x80A40CC1, 65535, sizeof(LightBulb_eventServerSetLightColor_Parms));
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				...
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_ALightBulb_ServerSetLightColor(), "ServerSetLightColor"); // 372428354
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
	...
	UClass* Z_Construct_UClass_ALightBulbController_NoRegister()
	{
		return ALightBulbController::StaticClass();
	}
	UClass* Z_Construct_UClass_ALightBulbController()
	{
		static UClass* OuterClass = NULL;
		if (!OuterClass)
		{
			...
			Z_Construct_UPackage__Script_ZadanieRekrutacyjne();
			OuterClass = ALightBulbController::StaticClass();
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				UObjectForceRegistration(OuterClass);
				...
				MetaData->SetValue(OuterClass, TEXT("IncludePath"), TEXT("LightBulbController.h"));
				MetaData->SetValue(OuterClass, TEXT("ModuleRelativePath"), TEXT("LightBulbController.h"));
#endif
			}
		}
		check(OuterClass->GetClass());
	...
	static FCompiledInDefer Z_CompiledInDefer_UClass_ALightBulbController(Z_Construct_UClass_ALightBulbController, &ALightBulbController::StaticClass, TEXT("ALightBulbController"), false, nullptr, nullptr, nullptr);
	DEFINE_VTABLE_PTR_HELPER_CTOR(ALightBulbController);
